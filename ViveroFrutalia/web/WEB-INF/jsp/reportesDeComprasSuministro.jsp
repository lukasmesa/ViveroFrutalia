                    ...
                    <table class="table table-hover" style = "background-color: white">
                        ...
                        <tbody>
                            <%
                                ...
                                List<SuministrosCompra> lista = (List<SuministrosCompra>) request.getAttribute("reportesDeComprasSuministro");
                                for (SuministrosCompra i : lista) {
                            %>
                            <tr>
                                <td> <%=i.getId()%> </td>
                                <td> <%=i.getCompraSuministros().getId()%> </td>
                                <td> <%=i.getSuministros().getId()%> </td>
                                <td> <%=i.getSuministros().getNombre()%> </td>
                                <td> <%=i.getCantidad()%> </td>
